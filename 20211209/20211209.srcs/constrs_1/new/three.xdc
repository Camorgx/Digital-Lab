...
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { reset }];
...
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { button }];#used to be rst_n before
